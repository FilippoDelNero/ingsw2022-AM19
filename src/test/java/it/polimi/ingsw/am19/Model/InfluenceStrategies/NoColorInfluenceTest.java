...
import it.polimi.ingsw.am19.Model.*;
import org.junit.jupiter.api.Test;
import java.util.HashMap;
import java.util.Map;
import static org.junit.jupiter.api.Assertions.*;

public class NoColorInfluenceTest {
    /**
     * testing the NoColorInfluence points to the current player
     */
    @Test
    void testCalculateInfluenceWithPlusTwo() {
        ...
        Island island = new Island(map, TowerColor.WHITE, true, noColorInfluence, 1);
        ...
        noColorInfluence.setColor(PieceColor.BLUE);
    ...
    void testCalculateInfluenceWithNoPreviousOwner() {
        ...
        Island island = new Island(map, null, true, noColorInfluence, 1);
    ...
    /**
     * test the influence calculation of a previously NON-owned island and three players with same influence
     */
    @Test
    ...
    void testCalculateInfluenceNoOwnershipChange() {
        ...
        Island island = new Island(map, TowerColor.BLACK, true, noColorInfluence, 1);

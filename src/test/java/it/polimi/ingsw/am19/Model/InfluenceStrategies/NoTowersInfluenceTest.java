...
public class NoTowersInfluenceTest {
    /**
     * testing the noTowerInfluence points to the current player
     */
    @Test
    void testCalculateInfluenceWithNoTower() {
        //--ISLAND PART--
        NoTowersInfluence noTowersInfluence = new NoTowersInfluence();
        ...
        Island island = new Island(map, TowerColor.WHITE, true, noTowersInfluence, 1);
    ...
    void testCalculateInfluenceWithNoPreviousOwner() {
        ...
        map.put(PieceColor.BLUE, 1);
        map.put(PieceColor.YELLOW, 0);
        map.put(PieceColor.PINK, 0);

        Island island = new Island(map, null, true, noTowersInfluence, 1);
    ...
    void testCalculateInfluenceNoOwnershipChange() {
        ...
        map.put(PieceColor.YELLOW, 1);
        map.put(PieceColor.PINK, 3);

        Island island = new Island(map, TowerColor.BLACK, true, noTowersInfluence, 1);

...
public class NoEntryTileCardTest {
    ...
    void activateEffectTest() {
        ...
        card.activateEffect(island, null);
    ...
    @Test
    void activateEffectFiveTimesTest() {
        AbstractMatch m = new TwoPlayersMatch();
